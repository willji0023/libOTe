...
namespace tests_libOTe
{
    ...
    void OtExt_genBaseOts_Test()
    {
        ...
        auto p1 = sender.genBaseOts(prng);
    ...
    void OtExt_Kos_Test()
    {
        ...
        coproto::LocalEvaluator eval;
        auto ec = eval.execute(p0, p1, coproto::LocalEvaluator::interlace, false);
        if (ec)
            throw std::runtime_error(ec.message());
    ...
    void OtExt_Chosen_Test()
    {
        ...
        auto p0 = recv.receiveChosen(choices, recvMsg, prng1);
        auto p1 = sender.sendChosen(sendMsg, prng0);
